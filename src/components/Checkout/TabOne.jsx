            ...
            <Box width="100%">
                <FormControl isInvalid={isFormError}>
                    ...
                    <Box display="flex" justifyContent="space-between" w='100%'>
                        <Box w='49%' className={styles.inputBox}>
                    ...
                    <Box className={styles.inputBox}>
                        ...
                        <Input name='postcode' value={formData.postcode} onChange={(e) => setFormData({ ...formData, postcode: e.target.value })} w='49%' className={styles.inputs} h='45px' borderRadius='' variant='' type="text" />
                        {!isPostcodeError
                            ? ""
                            : (
                    ...
                    <Box className={styles.inputBox}>
                        ...
                        <InputGroup w='49%' border="1px solid #939395">
